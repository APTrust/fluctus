Fluctus::Application.routes.draw do
  ...
  get 'files/*intellectual_object_identifier', to: 'generic_files#index', as: :intellectual_object_files, :constraints => { :intellectual_object_identifier => object_identifier_ptrn }
  post 'files/*intellectual_object_identifier', to: 'generic_files#create', as: :intellectual_object_generic_files, :constraints => { :intellectual_object_identifier => object_identifier_ptrn }
  get 'files/*generic_file_identifier', to: 'generic_files#show', as: :generic_file, :constraints => { :generic_file_identifier => file_ptrn }
  patch 'files/*generic_file_identifier', to: 'generic_files#update', :constraints => { :generic_file_identifier => file_ptrn }, trailing_slash: true, format: 'json'
  ...
  post 'files/*generic_file_identifier/events', to: 'events#create', :constraints => { :generic_file_identifier => file_ptrn }
