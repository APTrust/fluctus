    ...
    describe "when signed in" do
      ...
      describe "and assigning to an object you don't have access to" do
        ...
        it "should be forbidden" do
          post :create, intellectual_object_id: obj1, generic_file: {uri: 'path/within/bag', size: 12314121, created: '2001-12-31', modified: '2003-03-13', format: 'text/html', md5_attributes: [{digest: "123ab13df23", algorithm: 'MD6', datetime: '2003-03-13T12:12:12Z'}]}, format: 'json'
      ...
      it "should show errors" do
        ...
        expect(JSON.parse(response.body)).to eq( {
          ...
          "md5" => ['either this or the sha256 needs a value'],
          "sha256" => ['either this or the md5 needs a value'],
      ...
      it "should update fields" do
        ...
        post :create, intellectual_object_id: obj1, generic_file: {uri: 'path/within/bag', content_uri: 'http://s3-eu-west-1.amazonaws.com/mybucket/puppy.jpg', size: 12314121, created: '2001-12-31', modified: '2003-03-13', format: 'text/html', identifier: 'test.edu/12345678/data/mybucket/puppy.jpg', md5_attributes: [{digest: "123ab13df23", algorithm: 'MD6', datetime: '2003-03-13T12:12:12Z'}]}, format: 'json'
