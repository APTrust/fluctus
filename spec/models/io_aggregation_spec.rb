...
describe IoAggregation do
  ...
  it 'should properly remove a format' do
  ...
  it 'should properly remove from the file size' do
    subject.file_size = 100.0
    subject.remove_from_size(25.0)
    subject.file_size.should == 75.0
  end

  it 'should properly convert the file_format attribute into a mpa' do
