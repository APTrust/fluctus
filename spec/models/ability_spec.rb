...
describe Ability do
  describe 'an admin user' do
    ...
    it { should be_able_to(:manage_user_roles, user) }
    it { should be_able_to(:manage_user_institution, user) }
  ...
  describe 'an institutional_admin user' do
    ...
    describe "when the user is in my institution" do
      ...
      it { should     be_able_to(:manage_user_roles, user) }
      it { should_not be_able_to(:manage_user_institution, user) }
    ...
    describe "when the user is not in my institution" do
      ...
      it { should_not be_able_to(:manage_user_roles, user) }
      it { should_not be_able_to(:manage_user_institution, user) }
      it { should_not be_able_to(:assign_admin_user, user) }
    end
  end
