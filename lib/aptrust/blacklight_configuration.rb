  ...
  module BlacklightConfiguration
    ...
    included do
      ...
      configure_blacklight do |config|
        ...
        config.add_sort_field 'score desc, system_create_dtsi desc, desc_metadata__title_tesi asc', :label => 'relevance'
        config.add_sort_field 'pub_date_dtsi desc, title_tesi asc', :label => 'date added'
        config.add_sort_field 'desc_metadata__title_tesi asc, system_create_dtsi desc', :label => 'title'
